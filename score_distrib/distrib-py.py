...
## DescribeResult(nobs=100000, minmax=(0.0, 0.88), mean=0.19499919166666665, 
## variance=0.019145474928679213, skewness=1.092137155177536, kurtosis=1.0480606473920924)
